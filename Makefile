...
ifndef UNATTENDED_CREATION
	...
	@echo "chown 32767:32767 /var/lib/dokku/data/storage/$(APP_NAME)"
	@echo "dokku storage:mount $(APP_NAME) /var/lib/dokku/data/storage/$(APP_NAME):/app/"
	@echo ""
	...
	$(DOKKU_CMD) storage:mount $(APP_NAME) /var/lib/dokku/data/storage/$(APP_NAME):/app/
